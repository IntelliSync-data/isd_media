    ...
    "data": [
        {
            ...
            <h4>cURL Example</h4>
            <pre style="background: #2d3436; color: #dfe6e9; padding: 15px; border-radius: 6px; overflow-x: auto;">curl -X GET %(base_url)s/api/v1/categories</pre>
...
curl -X GET %(base_url)s/api/v1/media

# Get page 2 with 10 items per page
curl -X GET "%(base_url)s/api/v1/media?page=2&amp;limit=10"

# Filter by category
curl -X GET "%(base_url)s/api/v1/media?categoryId=1"</pre>
...
App Start  -->  GET /api/v1/version  -->  Version Changed?
                                          |           |
                                         YES          NO
                                          |           |
